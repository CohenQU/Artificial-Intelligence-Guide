 ...
 * [Neural Adversarial Training for Semi-supervised Japanese Predicate-argument Structure Analysis](https://arxiv.org/abs/1806.00971)
 * [No Metrics Are Perfect: Adversarial Reward Learning for Visual Storytelling](https://arxiv.org/abs/1804.09160)
 * [Adversarial Contrastive Estimation](https://arxiv.org/abs/1805.03642)
 * [Semantically Equivalent Adversarial Rules for Debugging NLP models](https://aclweb.org/anthology/papers/P/P18/P18-1079/)
 * [Attacking Visual Language Grounding with Adversarial Examples: A Case Study on Neural Image Captioning](https://arxiv.org/abs/1712.02051)
 * [Domain Adaptation with Adversarial Training and Graph Embeddings](https://arxiv.org/abs/1805.05151)
 * [Self-regulation: Employing a Generative Adversarial Network to Improve Event Detection](https://aclweb.org/anthology/papers/P/P18/P18-1048/)
 * [DSGAN: Generative Adversarial Training for Distant Supervision Relation Extraction](https://arxiv.org/abs/1805.09929)
 * [HotFlip: White-Box Adversarial Examples for Text Classification](https://arxiv.org/abs/1712.06751)
 * [Trick Me If You Can: Adversarial Writing of Trivia Challenge Questions](https://aclweb.org/anthology/papers/P/P18/P18-3018/)
